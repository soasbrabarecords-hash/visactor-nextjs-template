...
export default function SpotifyPlaylistAddButton({
  ...
  function handleOpen() {
    ...
    if (btnRef.current) {
      ...
      setMenuSide(rect.right + 300 > window.innerWidth ? "left" : "right");
    }
    ...
    <div className="relative inline-flex">
      ...
      {open ? (
        <div
          ref={menuRef}
          className={cn(
            "absolute top-[calc(100%+0.5rem)] z-50 w-72 overflow-hidden rounded-[20px] border border-white/10 bg-[#0c1013] text-white shadow-[0_24px_64px_rgba(0,0,0,0.42)]",
