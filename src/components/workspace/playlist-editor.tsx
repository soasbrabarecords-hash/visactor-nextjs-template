...
export default function PlaylistEditor({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Barra de controles — legendas escondem em mobile p/ economizar espaço */}
      ...
      {/*
        ...
        ─────────────────────────────────
        - Coluna "Música" agora inclui capa + título + artistas (empilhados)
        - Colunas secundárias escondem progressivamente em telas menores
          (mobile: só Música/Pop/Ações | tablet: + Duração | desktop: + Álbum/Streams/Chart)
        - Larguras flexíveis: Música expande, demais ficam com width auto/fixo
      */}
